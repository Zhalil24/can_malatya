...
import '../../home_create/view/home_create_view.dart';
import '../../home_detail/view/home_detail_view.dart';
import '../../job_posting/view/job_posting_view.dart';
      ...
      body: Stack(
        children: [
          PageView(
            ...
            children: [homeView(context), const JobPostingView(), const NewsView(), const WeatherView()],
          ),
          if (ref.watch(homeProvider).isLoading ?? false) const Center(child: CircularProgressIndicator()),
        ],
      ),
